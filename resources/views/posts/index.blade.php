                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <ul>
                            ...
                            <a href="#" class="add-modal"><li>Add a User</li></a>
                        </ul>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="postTable" style="visibility: hidden;">
                                ...
                                <tbody>
                                    @foreach($posts as $indexKey => $post)
                                        <tr class="item{{$post->id}} @if($post->enabled) warning @endif">
                                            <td class="col1">{{ $indexKey+1 }}</td>
                                            <td>{{$post->nama}}</td>
                                            <td>{{$post->jabatan}}</td>
                                            <td>{{$post->email}}</td>
                                            <td>{{$post->status}}</td>
                                            <td> <img src="{{url('/image/', $post->foto)}}" height="100" width="100" /></td>
                                            <td>
                                                <button class="show-modal btn btn-success" data-id="{{$post->id}}" data-nama="{{$post->nama}}" data-jabatan="{{$post->jabatan}}" data-email="{{$post->email}}" data-role="{{$post->role}}" data-status="{{$post->status}}" data-foto="{{$post->foto}}">
                                                <span class="glyphicon glyphicon-eye-open"></span> Show</button>
                                                <button class="edit-modal btn btn-info" data-id="{{$post->id}}" data-nama="{{$post->nama}}" data-jabatan="{{$post->jabatan}}" data-email="{{$post->email}}" data-role="{{$post->role}}" data-status="{{$post->status}}" data-foto="{{$post->foto}}">
                                                <span class="glyphicon glyphicon-edit"></span> Edit</button>
                                                <button class="delete-modal btn btn-danger" data-id="{{$post->id}}" data-nama="{{$post->nama}}" data-jabatan="{{$post->jabatan}}" data-email="{{$post->email}}" data-role="{{$post->role}}" data-status="{{$post->status}}" data-foto="{{$post->foto}}">
